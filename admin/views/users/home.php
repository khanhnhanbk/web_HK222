                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Total purchased</th>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <form action="/admin/user/detail" method="post">
                                                        <input type="hidden" name="id" value="<?= $user['id']; ?>">
                                                        <button type="submit" class="btn btn-sm btn-primary" name="detail-user-btn">Detail</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </td>
